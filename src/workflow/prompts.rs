...
Напиши секцию «Профессиональное резюме» — 2-4 абзаца, заточенные под эту вакансию.
Контакты, навыки, опыт работы, образование, сертификаты и языки шаблон добавит
из профиля автоматически — НЕ дублируй эти секции и не используй заголовки.
...
Ответь только текстом саммари, без заголовков и обрамления.
"#,
